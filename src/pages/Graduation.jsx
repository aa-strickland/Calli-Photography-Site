...
export default function Graduation() {
  ...
  // Force the leaf asset to render as solid dark forest green
  const leafFilter =
  ...
  // Graduation1.JPG - Graduation13.JPG in /public/Albums/Graduation
  const gradFiles = Array.from(
    { length: 13 },
    (_, i) => `/Albums/Graduation/Graduation${i + 1}.JPG`
  );
    ...
    >
      ...
      >
        ...
        <p style={{ fontSize: "1.1rem", marginBottom: 28 }}>
          Celebrating caps, gowns, and big milestones.
        </p>

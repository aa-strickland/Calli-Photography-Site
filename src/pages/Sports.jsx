...
export default function Sports() {
  ...
  // Sports1.JPG - Sports12.JPG in /public/Albums/Sports
  const sportFiles = Array.from({ length: 12 }, (_, i) => `/Albums/Sports/Sports${i + 1}.JPG`);
    ...
    >
      ...
      >
        ...
        <p style={{ fontSize: "1.1rem", marginBottom: 28 }}>
          A collection of sports memories.
        </p>

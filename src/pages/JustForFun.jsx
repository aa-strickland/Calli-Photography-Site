...
export default function JustForFun() {
  ...
  // JFF1.JPG - JFF17.JPG in /public/Albums/JFF
  const funFiles = Array.from(
    { length: 17 },
    (_, i) => `/Albums/JFF/JFF${i + 1}.JPG`
  );
    ...
    >
      ...
      >
        ...
        <p style={{ fontSize: "1.1rem", marginBottom: 28 }}>
          A collection of fun, candid, and creative shots.
        </p>
        ...
        >
          {funFiles.map((src, idx) => (
            <img
              key={src}
              src={src}
              alt={`Just For Fun ${idx + 1}`}
              style={{
                width: "100%",
                borderRadius: 10,
                border: `2px solid ${forestGreen}`,
